...
import org.lastmilehealth.collect.android.listeners.DeleteInstancesListener;
import org.lastmilehealth.collect.android.provider.InstanceProviderAPI.InstanceColumns;
import org.lastmilehealth.collect.android.tasks.DeleteInstancesTask;
...
public class DataManagerList extends ListActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		int[] view = new int[] { R.id.blank_form_item_name, R.id.text2 };

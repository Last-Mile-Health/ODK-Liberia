...
public final class InstanceProviderAPI {
    public static final String AUTHORITY_INSTANCES = "org.lastmilehealth.collect.android.provider.odk.instances";
    public static final String AUTHORITY_ARCHIVES = "org.lastmilehealth.collect.android.provider.odk.archives";
    ...
    public static final class InstanceColumns implements BaseColumns {
        ...
        public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY_INSTANCES + "/instances");
        public static final Uri CONTENT_URI_ARCHIVES = Uri.parse("content://" + AUTHORITY_ARCHIVES + "/instances");

...
import org.lastmilehealth.collect.android.listeners.DeleteFormsListener;
...
import org.lastmilehealth.collect.android.tasks.DeleteFormsTask;
import org.lastmilehealth.collect.android.tasks.DiskSyncTask;
import org.lastmilehealth.collect.android.utilities.BlankFormAdapter;
...
public class FormManagerList extends ListActivity implements DiskSyncListener,
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		int[] view = new int[] { R.id.blank_form_item_name, R.id.text2, R.id.blank_form_item_version};

		// render total instance view
		mInstances = new BlankFormAdapter(FormsColumns.JR_VERSION, this,

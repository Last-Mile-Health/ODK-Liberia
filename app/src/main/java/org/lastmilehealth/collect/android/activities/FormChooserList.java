...
public class FormChooserList extends ListActivity implements DiskSyncListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor = managedQuery(FormsColumns.CONTENT_URI, null, null, null, sortOrder);

        String[] data = new String[] {
                FormsColumns.DISPLAY_NAME, FormsColumns.DISPLAY_SUBTEXT, FormsColumns.JR_VERSION
        };
        int[] view = new int[] {
                R.id.blank_form_item_name, R.id.text2, R.id.blank_form_item_version
        };

        // render total instance view
        SimpleCursorAdapter instances =
                new BlankFormAdapter(FormsColumns.JR_VERSION, this, R.layout.blank_form_item, cursor, data, view);
